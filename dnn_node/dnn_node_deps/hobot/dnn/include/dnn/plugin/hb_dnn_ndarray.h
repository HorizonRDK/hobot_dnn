...
class NDArray {
 public:
  ...
  explicit NDArray(const TShape &shape, TypeFlag dtype = kFloat32);

  explicit NDArray(void *dptr, const TShape &shape, TypeFlag dtype = kFloat32);
   ...
   */
  inline int32_t NDim() const { return shape_.NDim(); }
