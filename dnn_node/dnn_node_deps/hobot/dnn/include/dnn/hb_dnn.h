...
#define HB_DNN_VERSION_MINOR 6U
 ...
 * @return 0 if success, return defined error code otherwise
 */
int32_t hbDNNGetInputName(const char **name, hbDNNHandle_t dnnHandle,
                          int32_t inputIndex);
 ...
 * @return 0 if success, return defined error code otherwise
 */
int32_t hbDNNGetOutputName(const char **name, hbDNNHandle_t dnnHandle,
                           int32_t outputIndex);
